...
lotr_tidy %>%
  spread(key = Gender, value = "Female", "Male")
#I got an error doing the above; re-tried line 217 and
#got the expected results (lines220-230)
...
#spread and pivot_wider functions are different: use "key" and "values" for spread
#but use "names_from" and "values_from" for pivot_wider
